...
// Usuários
const ListaUsuarios = lazy(() => import("@/app/(admin)/usuarios/page"));
const CriarUsuario = lazy(() => import("@/app/(admin)/usuarios/criar/page"));

// Posts
const ListaPosts = lazy(() => import("@/app/(admin)/posts/page"));
const CriarPost = lazy(() => import("@/app/(admin)/posts/criar/page"));
const EditarPost = lazy(() => import("@/app/(admin)/posts/editar/[id]/page"));
const VisualizarPost = lazy(() => import("@/app/(admin)/posts/visualizar/[id]/page"))

const CategoriesPage = lazy(() => import("@/app/(admin)/categories/page"));

const ListaBanners = lazy(() => import("@/app/(admin)/banners/page"));
const CriarBanner = lazy(() => import("@/app/(admin)/banners/criar/page"));
const BannersAnalytics = lazy(() => import('@/app/(admin)/dashboard/banners-analytics/page'));
  ...
  const generalRoutes: RoutesProps[] = [
    ...
    {
      path: '/dashboard/banners-analytics',
      name: 'Banners Analytics',
      element: <BannersAnalytics />,
    },
  ]

  const usuariosRoutes: RoutesProps[] = [
    {
      path: "/admin/usuarios",
  ...
  const postsRoutes: RoutesProps[] = [
    ...
    {
      path: "/admin/posts/criar",
      name: "Criar Post",
      element: <CriarPost />,
    },
    {
      path: "/admin/posts/editar/:postId",
      name: "Editar Post",
      element: <EditarPost />,
    },
    {
      path: "/admin/posts/visualizar/:postId",
      name: "Visualizar Post",
      element: <VisualizarPost />,
    },
  ];
  ...
  const categoriesRoutes: RoutesProps[] = [
    {
      ...
      name: "Categorias de Posts",
      element: <CategoriesPage />,
    },
  ];

  const bannersRoutes: RoutesProps[] = [
    {
      path: "/admin/banners",
      name: "Todos os Banners",
      element: <ListaBanners />,
    },
    {
      path: "/admin/banners/criar",
      name: "Criar Banner",
      element: <CriarBanner />,
    },
  ];
