...
const ContainerCard = ({ name, handle, avatar, children }: { name: string; handle: string; avatar: string; children: ReactNode }) => {
  return (
            ...
            <div className="d-flex justify-content-between fw-semibold align-items-center  my-3">
              <div className="img-group d-flex justify-content-center">
                {members.slice(0, 3).map((member, idx) => (
                  <Link key={idx} className={clsx('user-avatar position-relative d-inline-block', { 'ms-n2': idx != 0 })} to="#">
