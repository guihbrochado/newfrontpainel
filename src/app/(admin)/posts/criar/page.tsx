  ...
  const CreatePost = () => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
      ...
      if (!token || !user) {
        setError("Usuário não autenticado ou token ausente. Faça login novamente.");
        navigate("/login"); // Redireciona para login se não houver token ou usuário
        return;
      }
      ...
      exportHtml(async (html) => {
        ...
        console.log("Dados enviados no FormData:", Object.fromEntries(formData));
